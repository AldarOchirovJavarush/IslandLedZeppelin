...
@RegisteredOrganism(DefaultOrganismConfigFactory.OrganismType.DEER)
public class Deer extends Herbivore {
    public Deer(OrganismConfig config, AbstractOrganismService movementService, AbstractOrganismService eatingService, AbstractOrganismService deathService, AbstractOrganismService reproduceService) {
