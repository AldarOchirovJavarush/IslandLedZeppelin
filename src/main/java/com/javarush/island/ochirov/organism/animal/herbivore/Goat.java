...
@RegisteredOrganism(DefaultOrganismConfigFactory.OrganismType.GOAT)
public class Goat extends Herbivore {
    public Goat(OrganismConfig config, AbstractOrganismService movementService, AbstractOrganismService eatingService, AbstractOrganismService deathService, AbstractOrganismService reproduceService) {
