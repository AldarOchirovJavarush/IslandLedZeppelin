...
@RegisteredOrganism(DefaultOrganismConfigFactory.OrganismType.BUFFALO)
public class Buffalo extends Herbivore {
    public Buffalo(OrganismConfig config, AbstractOrganismService movementService, AbstractOrganismService eatingService, AbstractOrganismService deathService, AbstractOrganismService reproduceService) {
