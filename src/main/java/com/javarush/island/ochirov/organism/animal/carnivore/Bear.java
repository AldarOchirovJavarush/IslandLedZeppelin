...
@RegisteredOrganism(DefaultOrganismConfigFactory.OrganismType.BEAR)
public class Bear extends Carnivore {
    public Bear(OrganismConfig config, AbstractOrganismService movementService, AbstractOrganismService eatingService, AbstractOrganismService deathService, AbstractOrganismService reproduceService) {
