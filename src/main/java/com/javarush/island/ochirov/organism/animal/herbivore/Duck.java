...
@RegisteredOrganism(DefaultOrganismConfigFactory.OrganismType.DUCK)
public class Duck extends Herbivore {
    public Duck(OrganismConfig config, AbstractOrganismService movementService, AbstractOrganismService eatingService, AbstractOrganismService deathService, AbstractOrganismService reproduceService) {
