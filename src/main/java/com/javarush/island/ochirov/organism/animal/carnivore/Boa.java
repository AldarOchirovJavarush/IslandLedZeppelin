...
@RegisteredOrganism(DefaultOrganismConfigFactory.OrganismType.BOA)
public class Boa extends Carnivore {
    public Boa(OrganismConfig config, AbstractOrganismService movementService, AbstractOrganismService eatingService, AbstractOrganismService deathService, AbstractOrganismService reproduceService) {
