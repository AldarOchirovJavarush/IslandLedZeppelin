...
@RegisteredOrganism(DefaultOrganismConfigFactory.OrganismType.FOX)
public class Fox extends Carnivore {
    public Fox(OrganismConfig config, AbstractOrganismService movementService, AbstractOrganismService eatingService, AbstractOrganismService deathService, AbstractOrganismService reproduceService) {
